...
public class SachGiaoKhoa_Cap3 extends SachGiaoKhoa {
	...
	public SachGiaoKhoa_Cap3(String maSach,String tenSach, String nhaXuatBan,String loaiSach,String lop, Date ngayXuatBan, Date ngayNhapKho, int soLanTaiBan,
			int soLuong) {
		super(maSach,tenSach, nhaXuatBan,loaiSach,lop,ngayXuatBan, ngayNhapKho, soLanTaiBan, soLuong);
	...
	public SachGiaoKhoa_Cap3(String tenSach) {
		super(tenSach);
	}
	...
	public void chinhsuathongtin() {
		...
		}while(super.loaiSach!="cap 1"||super.loaiSach!="cap 2"||super.loaiSach!="cap 3");
		System.out.println("");
	...
	public String toString() {
		return "SachGiaoKhoa_Cap3 "+ super.toString();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SachGiaoKhoa_Cap3 other = (SachGiaoKhoa_Cap3) obj;
