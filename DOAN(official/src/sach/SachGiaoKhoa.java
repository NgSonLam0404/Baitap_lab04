...
public abstract class SachGiaoKhoa implements Comparable<SachGiaoKhoa>,Serializable {
	protected String maSach,tenSach, nhaXuatBan,loaiSach, lop;
	protected Date ngayXuatBan, ngayNhapKho;
	protected int soLanTaiBan, soLuong;

	public SachGiaoKhoa(String maSach,String tenSach, String nhaXuatBan,String loaiSach,String lop, Date ngayXuatBan, Date ngayNhapKho, int soLanTaiBan,
			int soLuong) {
		this.maSach = maSach;
	...
	public String toString() {
		return "SachGiaoKhoa [maSach:" + maSach+ ", ten sach: "+tenSach + ", loai sach: "+loaiSach+ ", lop: "+lop+ ", nhaXuatBan: " + nhaXuatBan + ", ngayXuatBan:"
