...
public class SachGiaoKhoa_Cap2 extends SachGiaoKhoa {
	...
	public SachGiaoKhoa_Cap2(String maSach,String tenSach, String nhaXuatBan,String loaiSach,String lop, Date ngayXuatBan, Date ngayNhapKho, int soLanTaiBan,
			int soLuong) {
