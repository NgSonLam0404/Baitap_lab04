...
public class MainTest {
	public static void main(String[] args) {
		...
		qlsv.addStudent(new Student("SV001","Nguyen Van A",1998));
		qlsv.addStudent(new Student("SV006","Tran Van B",1998));
		qlsv.addStudent(new Student("SV002","Le Van C",1998));
		qlsv.addStudent(new Student("SV008","Dang Van D",1998));
		qlsv.addStudent(new Student("SV003","Ngo Van E",1998));
